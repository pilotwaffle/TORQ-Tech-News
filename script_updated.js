/**
 * TORQ Tech News - JavaScript
 * Interactive functionality with real newsletter subscription
 */
...
/**
 * Newsletter Form Handling with Real API Integration
 */
function initNewsletterForm() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        .catch(error => {
            ...
            showMessage(error.message || 'Failed to subscribe. Please try again later.', 'error');
        })
        .finally(() => {
            // Reset button state
...
console.log('TORQ Tech News - Landing Page Loaded');
